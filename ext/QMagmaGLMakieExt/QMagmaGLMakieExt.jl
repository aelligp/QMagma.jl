...
using QMagma: EnthalpyBudget, EruptionEvent, EruptionParams, EruptionState, MassBudget,
    ...
    eruption_control_state, export_thermal_structure, gaussian_thermal_structure,
    gui_composition, gui_flux_history, init_model, init_tracers, injected_thickness,
    injection_depth, insert_sill, integrated_content, lateral_loss_energy, magma_heat_input,
